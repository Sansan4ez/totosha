...
TOOLS = {
    "corp_wiki_search": {
        ...
        "description": "Deprecated alias of doc_search. Search the local document corpus for explicit document context or fallback after corp_db_search empty/error.",
        "source": "builtin",
        "parameters": {
            "type": "object",
            "properties": {
