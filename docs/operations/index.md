...
Use this index for local runtime operations, observability triage, smoke execution, and Docker Compose topology.

Read by Intent
--------------

- Bring up the stack locally -> `README.md`
- Review the bench module layout and usage -> `bench/README.md`
