    ...
    finalizer_messages.append(
        {
            "role": "user",
            "content": (
                "Сформулируй финальный ответ пользователю по этим retrieved evidence. "
                "Вопросы о тебе самом (кто ты, что умеешь, чем можешь помочь) — отвечай по своей роли, "
                "инструментам и навыкам из системного промпта, даже если evidence о них молчит. "
                "Если вопрос не о тебе и evidence на него не отвечает, скажи что данных недостаточно.\n"
