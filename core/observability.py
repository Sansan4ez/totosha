...
SPAN_ATTRIBUTE_NAMES = {
    ...
    "selected_business_family_id": "selected_business_family_id",
    "selected_leaf_route_id": "selected_leaf_route_id",
    ...
    "used_fallback_route_id": "used_fallback_route_id",
...
RETRIEVAL_ROUTE_FAMILY_REQUESTS_TOTAL = Counter(
    "retrieval_route_family_requests_total",
    "Requests grouped by business family, stage, and validation outcome.",
    labelnames=(
        "service",
        "status",
        "selected_business_family_id",
...
RETRIEVAL_ROUTE_LEAF_REQUESTS_TOTAL = Counter(
    "retrieval_route_leaf_requests_total",
    "Requests grouped by canonical route, leaf route, stage, and validation outcome.",
    labelnames=(
        "service",
        "status",
        "selected_route_id",
...
RETRIEVAL_ROUTE_LEAF_ERRORS_TOTAL = Counter(
    "retrieval_route_leaf_errors_total",
    "Non-sufficient routed requests grouped by leaf route and close reason.",
    labelnames=(
        "service",
        "selected_route_id",
        "selected_leaf_route_id",
...
RETRIEVAL_ROUTE_LEAF_DURATION_MS = Histogram(
    "retrieval_route_leaf_duration_milliseconds",
    "Request duration grouped by leaf route, stage, validation outcome, and fallback scope.",
    labelnames=(
        "service",
        "selected_route_id",
        "selected_leaf_route_id",
...
RETRIEVAL_ROUTE_ARGUMENT_VALIDATION_ERRORS_TOTAL = Counter(
    "retrieval_route_argument_validation_errors_total",
    "Selector or route argument validation errors grouped by route identity and error code.",
    labelnames=(
        "service",
        "selected_route_id",
        "selected_leaf_route_id",
...
RETRIEVAL_ROUTE_FAMILY_FALLBACK_TOTAL = Counter(
    "retrieval_route_family_fallback_total",
    "Observed fallback executions grouped by business family, leaf route, scope, and fallback target.",
    labelnames=(
        "service",
        "selected_route_id",
        "selected_leaf_route_id",
...
RETRIEVAL_ROUTE_LOW_CONFIDENCE_TOTAL = Counter(
    "retrieval_route_low_confidence_total",
    "Requests where route selector confidence stayed below high.",
    labelnames=(
        "service",
        "selected_route_id",
        "selected_leaf_route_id",
...
RETRIEVAL_ROUTE_STAGE_TOTAL = Counter(
    "retrieval_route_stage_total",
    "Requests grouped by business family, leaf route, and route stage.",
    labelnames=(
        "service",
        "selected_business_family_id",
        "selected_leaf_route_id",
...
def observe_request_correlation(duration_ms: float, status: str) -> None:
    ...
    labels = (
        ...
        _metric_label(context, "selected_business_family_id"),
        _metric_label(context, "selected_leaf_route_id"),
    ...
    RETRIEVAL_ROUTE_FAMILY_REQUESTS_TOTAL.labels(
        ...
        _metric_label(context, "route_stage"),
        _metric_label(context, "selected_source", default="unknown"),
        _metric_label(context, "route_selector_status"),
        _metric_label(context, "route_arg_validation_status", default="none"),
    ).inc()
    RETRIEVAL_ROUTE_LEAF_REQUESTS_TOTAL.labels(
        ACTIVE_SERVICE_NAME,
        status,
        _metric_label(context, "selected_route_id"),
        _metric_label(context, "selected_leaf_route_id"),
    ...
    RETRIEVAL_ROUTE_LEAF_DURATION_MS.labels(
        ACTIVE_SERVICE_NAME,
        _metric_label(context, "selected_route_id"),
        _metric_label(context, "selected_leaf_route_id"),
        _metric_label(context, "selected_business_family_id"),
    ...
    RETRIEVAL_ROUTE_STAGE_TOTAL.labels(
        ACTIVE_SERVICE_NAME,
        _metric_label(context, "selected_business_family_id"),
        _metric_label(context, "selected_leaf_route_id"),
        _metric_label(context, "route_stage"),
    ...
    validation_status = _metric_label(context, "route_arg_validation_status", default="none")
    validation_error_code = _metric_label(context, "route_selector_validation_error_code")
    if validation_status in {"error", "repaired"}:
        RETRIEVAL_ROUTE_ARGUMENT_VALIDATION_ERRORS_TOTAL.labels(
            ACTIVE_SERVICE_NAME,
            _metric_label(context, "selected_route_id"),
            _metric_label(context, "selected_leaf_route_id"),
            _metric_label(context, "selected_business_family_id"),
    ...
    retrieval_evidence_status = _metric_label(context, "retrieval_evidence_status")
    retrieval_close_reason = _metric_label(context, "retrieval_close_reason")
    if validation_status == "error" or retrieval_evidence_status in {"empty", "error", "weak"}:
        RETRIEVAL_ROUTE_LEAF_ERRORS_TOTAL.labels(
            ACTIVE_SERVICE_NAME,
            _metric_label(context, "selected_route_id"),
            _metric_label(context, "selected_leaf_route_id"),
            _metric_label(context, "selected_business_family_id"),
    ...
    used_fallback_scope = _metric_label(context, "used_fallback_scope")
    if used_fallback_scope not in {"none", ""}:
        RETRIEVAL_ROUTE_FAMILY_FALLBACK_TOTAL.labels(
            ACTIVE_SERVICE_NAME,
            _metric_label(context, "selected_route_id"),
            _metric_label(context, "selected_leaf_route_id"),
            _metric_label(context, "selected_business_family_id"),
            ...
            _metric_label(context, "selected_source", default="unknown"),
            used_fallback_scope,
            _metric_label(context, "used_fallback_route_id"),
            _metric_label(context, "fallback_family_id"),
        ).inc()
    selector_confidence = _metric_label(context, "route_selector_confidence")
    if selector_confidence not in {"none", "", "high"}:
        RETRIEVAL_ROUTE_LOW_CONFIDENCE_TOTAL.labels(
            ACTIVE_SERVICE_NAME,
            _metric_label(context, "selected_route_id"),
            _metric_label(context, "selected_leaf_route_id"),
            _metric_label(context, "selected_business_family_id"),
