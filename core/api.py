...
def _build_run_meta(*, execution_mode: str) -> dict:
    return {
        ...
        "retrieval_fallback_route_count": 0,
        "retrieval_family_local_fallback_count": 0,
        "retrieval_cross_family_fallback_count": 0,
        "retrieval_attempted_fallback_count": 0,
        "retrieval_fallback_scope": "",
        "retrieval_fallback_family_id": "",
        "retrieval_cross_family_fallback_route_ids": [],
...
def _apply_meta_correlation(meta: dict, source: str) -> None:
    update_correlation_context(
        ...
        selected_business_family_id=str(meta.get("retrieval_business_family_id") or ""),
        selected_leaf_route_id=str(meta.get("retrieval_leaf_route_id") or ""),
        route_stage=str(meta.get("retrieval_route_stage") or ""),
        route_arg_validation_status=str(meta.get("retrieval_validation_status") or "none"),
        route_selector_validation_error_code=str(meta.get("route_selector_validation_error_code") or ""),
        route_selector_confidence=str(meta.get("route_selector_confidence") or ""),
        ...
        used_fallback_scope=str(meta.get("retrieval_used_fallback_scope") or ""),
        used_fallback_route_id=str(meta.get("retrieval_used_fallback_route_id") or ""),
        fallback_family_id=str(meta.get("retrieval_fallback_family_id") or ""),
